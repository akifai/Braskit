 ...
 * Ripped from http://www.postgresql.org/docs/9.2/static/errcodes-appendix.html
 *
 * @todo Add class matching shit.
 */
class PgError {
    ...
    const STRING_DATA_RIGHT_TRUNCATION_WARN                    = '01004';
    ...
    const EXTERNAL_ROUTINE_EXCEPTION_EXTERNAL                  = '38000';
    const CONTAINING_SQL_NOT_PERMITTED_EXTERNAL                = '38001';
    const MODIFYING_SQL_DATA_NOT_PERMITTED_EXTERNAL            = '38002';
    const PROHIBITED_SQL_STATEMENT_ATTEMPTED_EXTERNAL          = '38003';
    const READING_SQL_DATA_NOT_PERMITTED_EXTERNAL              = '38004';
